...
inline uint16_t csp_hton16(uint16_t h16) {
...
inline uint16_t csp_ntoh16(uint16_t n16) {
...
inline uint32_t csp_hton32(uint32_t h32) {
#ifdef CSP_BIG_ENDIAN
	return h32;
#else
...
inline uint32_t csp_ntoh32(uint32_t n32) {
...
inline uint64_t csp_hton64(uint64_t h64) {
#ifdef CSP_BIG_ENDIAN
	return h64;
#else
...
inline uint64_t csp_ntoh64(uint64_t n64) {
...
inline uint16_t csp_htobe16(uint16_t h16) {
...
inline uint16_t csp_htole16(uint16_t h16) {
...
inline uint16_t csp_betoh16(uint16_t be16) {
...
inline uint16_t csp_letoh16(uint16_t le16) {
...
inline uint32_t csp_htobe32(uint32_t h32) {
...
inline uint32_t csp_htole32(uint32_t h32) {
#ifdef CSP_LITTLE_ENDIAN
	return h32;
#else
	return (((h32 & 0xff000000) >> 24) |
...
inline uint64_t csp_htobe64(uint64_t h64) {
...
inline uint64_t csp_htole64(uint64_t h64) {
#ifdef CSP_LITTLE_ENDIAN
	return h64;
#else
	return (((h64 & 0xff00000000000000LL) >> 56) |
...
inline uint64_t csp_betoh64(uint64_t be64) {
...
inline uint64_t csp_letoh64(uint64_t le64) {
...
inline float csp_htonflt(float f) {
#ifdef CSP_BIG_ENDIAN
	return f;
#else
	union v {
...
inline float csp_ntohflt(float f) {
...
inline double csp_htondbl(double d) {
#ifdef CSP_BIG_ENDIAN
	return d;
#else
	union v {
...
inline double csp_ntohdbl(double d) {
