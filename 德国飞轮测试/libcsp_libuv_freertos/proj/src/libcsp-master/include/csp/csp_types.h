...
typedef struct __attribute__((__packed__)) {
	...
	union {
		...
		uint16_t data16[1];		/**< The data 16 and 32 types makes it easy to reference an integer (properly aligned) */
		uint32_t data32[1];		/**< without the compiler warning about strict aliasing rules. */
	};
} csp_packet_t;
